...
function config() {
  const loaded = loadBetaAdmissionConfig({
    ...
    BETA_ADMISSION_DATABASE_URL: `postgresql://payreplayy_beta_admission_runtime.${PAYREPLAYY_STAGING_SUPABASE_PROJECT_REFERENCE}:password@aws-0-eu-west-1.pooler.supabase.com:5432/postgres?sslmode=verify-full`,
