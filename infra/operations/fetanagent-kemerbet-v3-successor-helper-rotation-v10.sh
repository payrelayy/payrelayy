#!/usr/bin/env bash
# One-use, root-console-only tenth rotation of an installed KemerBet v3 successor helper.
# The immutable v2-to-v3 evidence and first nine helper-rotation links remain untouched;
# this operation appends one exact tenth link, keeps staging stopped, and never
# enables Transfer.
...
readonly THIRD_ROTATION_PARENT='/var/lib/fetanagent/kemerbet-readiness-v3-helper-rotation-v3'
readonly FOURTH_ROTATION_PARENT='/var/lib/fetanagent/kemerbet-readiness-v3-helper-rotation-v4'
readonly FIFTH_ROTATION_PARENT='/var/lib/fetanagent/kemerbet-readiness-v3-helper-rotation-v5'
readonly SIXTH_ROTATION_PARENT='/var/lib/fetanagent/kemerbet-readiness-v3-helper-rotation-v6'
readonly SEVENTH_ROTATION_PARENT='/var/lib/fetanagent/kemerbet-readiness-v3-helper-rotation-v7'
readonly EIGHTH_ROTATION_PARENT='/var/lib/fetanagent/kemerbet-readiness-v3-helper-rotation-v8'
readonly PREDECESSOR_ROTATION_PARENT='/var/lib/fetanagent/kemerbet-readiness-v3-helper-rotation-v9'
readonly ROTATION_PARENT='/var/lib/fetanagent/kemerbet-readiness-v3-helper-rotation-v10'
...
readonly THIRD_ROTATION_SUDOERS_DISABLED='/etc/sudoers.d/.fetanagent-staging-deploy-helper.v3-rotation-v3-disabled'
readonly FOURTH_ROTATION_SUDOERS_DISABLED='/etc/sudoers.d/.fetanagent-staging-deploy-helper.v3-rotation-v4-disabled'
readonly FIFTH_ROTATION_SUDOERS_DISABLED='/etc/sudoers.d/.fetanagent-staging-deploy-helper.v3-rotation-v5-disabled'
readonly SIXTH_ROTATION_SUDOERS_DISABLED='/etc/sudoers.d/.fetanagent-staging-deploy-helper.v3-rotation-v6-disabled'
readonly SEVENTH_ROTATION_SUDOERS_DISABLED='/etc/sudoers.d/.fetanagent-staging-deploy-helper.v3-rotation-v7-disabled'
readonly EIGHTH_ROTATION_SUDOERS_DISABLED='/etc/sudoers.d/.fetanagent-staging-deploy-helper.v3-rotation-v8-disabled'
readonly PREDECESSOR_SUDOERS_DISABLED='/etc/sudoers.d/.fetanagent-staging-deploy-helper.v3-rotation-v9-disabled'
readonly SUDOERS_DISABLED='/etc/sudoers.d/.fetanagent-staging-deploy-helper.v3-rotation-v10-disabled'
...
readonly THIRD_ROTATION_INSTALLING_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v3-installing'
readonly THIRD_ROTATION_INSTALLING_HELPER_PARTIAL="${THIRD_ROTATION_INSTALLING_HELPER}.partial"
readonly FOURTH_ROTATION_INSTALLING_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v4-installing'
readonly FOURTH_ROTATION_INSTALLING_HELPER_PARTIAL="${FOURTH_ROTATION_INSTALLING_HELPER}.partial"
readonly FIFTH_ROTATION_INSTALLING_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v5-installing'
readonly FIFTH_ROTATION_INSTALLING_HELPER_PARTIAL="${FIFTH_ROTATION_INSTALLING_HELPER}.partial"
readonly SIXTH_ROTATION_INSTALLING_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v6-installing'
readonly SIXTH_ROTATION_INSTALLING_HELPER_PARTIAL="${SIXTH_ROTATION_INSTALLING_HELPER}.partial"
readonly SEVENTH_ROTATION_INSTALLING_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v7-installing'
readonly SEVENTH_ROTATION_INSTALLING_HELPER_PARTIAL="${SEVENTH_ROTATION_INSTALLING_HELPER}.partial"
readonly EIGHTH_ROTATION_INSTALLING_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v8-installing'
readonly EIGHTH_ROTATION_INSTALLING_HELPER_PARTIAL="${EIGHTH_ROTATION_INSTALLING_HELPER}.partial"
readonly PREDECESSOR_INSTALLING_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v9-installing'
...
readonly THIRD_ROTATION_ROLLBACK_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v3-rollback'
readonly THIRD_ROTATION_ROLLBACK_HELPER_PARTIAL="${THIRD_ROTATION_ROLLBACK_HELPER}.partial"
readonly FOURTH_ROTATION_ROLLBACK_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v4-rollback'
readonly FOURTH_ROTATION_ROLLBACK_HELPER_PARTIAL="${FOURTH_ROTATION_ROLLBACK_HELPER}.partial"
readonly FIFTH_ROTATION_ROLLBACK_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v5-rollback'
readonly FIFTH_ROTATION_ROLLBACK_HELPER_PARTIAL="${FIFTH_ROTATION_ROLLBACK_HELPER}.partial"
readonly SIXTH_ROTATION_ROLLBACK_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v6-rollback'
readonly SIXTH_ROTATION_ROLLBACK_HELPER_PARTIAL="${SIXTH_ROTATION_ROLLBACK_HELPER}.partial"
readonly SEVENTH_ROTATION_ROLLBACK_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v7-rollback'
readonly SEVENTH_ROTATION_ROLLBACK_HELPER_PARTIAL="${SEVENTH_ROTATION_ROLLBACK_HELPER}.partial"
readonly EIGHTH_ROTATION_ROLLBACK_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v8-rollback'
readonly EIGHTH_ROTATION_ROLLBACK_HELPER_PARTIAL="${EIGHTH_ROTATION_ROLLBACK_HELPER}.partial"
readonly PREDECESSOR_ROLLBACK_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v9-rollback'
readonly PREDECESSOR_ROLLBACK_HELPER_PARTIAL="${PREDECESSOR_ROLLBACK_HELPER}.partial"
readonly INSTALLING_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v10-installing'
readonly INSTALLING_HELPER_PARTIAL="${INSTALLING_HELPER}.partial"
readonly ROLLBACK_HELPER='/usr/local/sbin/.fetanagent-staging-deploy-helper.v3-rotation-v10-rollback'
...
readonly THIRD_ROTATION_RELEASE='9c83821b4959f5ac52b0d642e476063ca7f3590e'
readonly THIRD_ROTATION_HELPER_SHA256='020b2b2d7eca153dffd72d7811d58c1a93e41edc24d1217cb459f5828e549b7b'
readonly FOURTH_ROTATION_RELEASE='874b8380a7e9f90806ebb1ad5c2958c1b245977f'
readonly FOURTH_ROTATION_HELPER_SHA256='8ae567bb50581288600ef8058553fb411d6b04d1177a275b4e59bed936bb1db6'
readonly FIFTH_ROTATION_RELEASE='882c29910a820d0fc4c934e2584ae157fe99309e'
readonly FIFTH_ROTATION_HELPER_SHA256='2fe840e137c435becc6179ba85cf00e86c1100b906da880b8f8e191a26cacd20'
readonly SIXTH_ROTATION_RELEASE='1f7239c4116be509e9ca38c7343969d1773af692'
readonly SIXTH_ROTATION_HELPER_SHA256='b3af405d303a123d4219ea8e6981ce447f9651abf83318879ebc3e579e318df1'
readonly SEVENTH_ROTATION_RELEASE='c73ba69d326be9c0b797b8fd9bbd77aa82cb89c9'
readonly SEVENTH_ROTATION_HELPER_SHA256='6be7cbcb5e3715c9d45ecc86005bdcb9b41f6d4cb86fbdffaf47525f416defc8'
readonly EIGHTH_ROTATION_RELEASE='ede557b85ce5878b57f2a6abd0775c530276f46d'
readonly EIGHTH_ROTATION_HELPER_SHA256='918fb4a5713a5d1fa5a3b214175e3a91dc6f5d505bd21d8fec85862416ac66cf'
readonly PREDECESSOR_RELEASE='31812cfc5403effdafa1d68fb641058bf14a8850'
readonly PREDECESSOR_HELPER_SHA256='d3284d1c268fdba227ff5628f2ac28f9e30375a8a85517e06258a97dfab5e4e1'
readonly REVIEWED_SUCCESSOR_HELPER_SHA256='73eabc728bc25462ab96d17dc8faa5775526571caae9d2ab0265f523b84a387e'
readonly CONFIRMATION='I-UNDERSTAND-THIS-APPENDS-TENTH-V3-HELPER-ROTATION-WITH-TRANSFER-DISABLED'
...
die() {
  printf 'FetanAgent v3 tenth helper rotation failed closed: %s\n' "$1" >&2
  exit 1
}
...
readonly STAGING_ROOT="/root/fetanagent-v3-helper-rotation-v10-$SUCCESSOR_RELEASE"
...
[[ "$SUCCESSOR_RELEASE" =~ ^[0-9a-f]{40}$ &&
  ...
  "$SUCCESSOR_RELEASE" != "$EIGHTH_ROTATION_RELEASE" &&
  "$SUCCESSOR_RELEASE" != "$SEVENTH_ROTATION_RELEASE" &&
  "$SUCCESSOR_RELEASE" != "$SIXTH_ROTATION_RELEASE" &&
  "$SUCCESSOR_RELEASE" != "$FIFTH_ROTATION_RELEASE" &&
  "$SUCCESSOR_RELEASE" != "$FOURTH_ROTATION_RELEASE" &&
  "$SUCCESSOR_RELEASE" != "$THIRD_ROTATION_RELEASE" &&
...
[[ "$SUCCESSOR_HELPER_SHA256" =~ ^[0-9a-f]{64}$ &&
  ...
  "$SUCCESSOR_HELPER_SHA256" != "$EIGHTH_ROTATION_HELPER_SHA256" &&
  "$SUCCESSOR_HELPER_SHA256" != "$SEVENTH_ROTATION_HELPER_SHA256" &&
  "$SUCCESSOR_HELPER_SHA256" != "$SIXTH_ROTATION_HELPER_SHA256" &&
  "$SUCCESSOR_HELPER_SHA256" != "$FIFTH_ROTATION_HELPER_SHA256" &&
  "$SUCCESSOR_HELPER_SHA256" != "$FOURTH_ROTATION_HELPER_SHA256" &&
  "$SUCCESSOR_HELPER_SHA256" != "$THIRD_ROTATION_HELPER_SHA256" &&
...
load_exact_predecessor_rotation_evidence() {
  ...
  inspection="$(env -i PATH="$SAFE_PATH" python3 -I - \
    "$FIRST_ROTATION_PARENT" "$SECOND_ROTATION_PARENT" "$THIRD_ROTATION_PARENT" \
    "$FOURTH_ROTATION_PARENT" "$FIFTH_ROTATION_PARENT" "$SIXTH_ROTATION_PARENT" \
    "$SEVENTH_ROTATION_PARENT" "$EIGHTH_ROTATION_PARENT" \
    "$PREDECESSOR_ROTATION_PARENT" \
    "$BASE_SUCCESSOR_RELEASE" "$FIRST_ROTATION_RELEASE" \
    "$SECOND_ROTATION_RELEASE" "$THIRD_ROTATION_RELEASE" \
    "$FOURTH_ROTATION_RELEASE" "$FIFTH_ROTATION_RELEASE" "$SIXTH_ROTATION_RELEASE" \
    "$SEVENTH_ROTATION_RELEASE" "$EIGHTH_ROTATION_RELEASE" "$PREDECESSOR_RELEASE" \
    "$BASE_SUCCESSOR_HELPER_SHA256" "$FIRST_ROTATION_HELPER_SHA256" \
    "$SECOND_ROTATION_HELPER_SHA256" "$THIRD_ROTATION_HELPER_SHA256" \
    "$FOURTH_ROTATION_HELPER_SHA256" "$FIFTH_ROTATION_HELPER_SHA256" \
    "$SIXTH_ROTATION_HELPER_SHA256" "$SEVENTH_ROTATION_HELPER_SHA256" \
    "$EIGHTH_ROTATION_HELPER_SHA256" "$PREDECESSOR_HELPER_SHA256" \
    "$BASE_SUCCESSOR_INTENT_SHA256" \
...
if (
    any(release.fullmatch(value) is None for value in
        (base_release, first_release, second_release, third_release, fourth_release,
         fifth_release, sixth_release, seventh_release, eighth_release, predecessor_release))
    or len({base_release, first_release, second_release, third_release, fourth_release,
            fifth_release, sixth_release, seventh_release, eighth_release,
            predecessor_release}) != 10
    or any(sha.fullmatch(value) is None for value in
           (base_helper, first_helper, second_helper, third_helper, fourth_helper,
            fifth_helper, sixth_helper, seventh_helper, eighth_helper, predecessor_helper,
            base_intent_sha, base_completion_sha, base_binding_v2_sha,
            base_old_helper_sha, base_binding_v3_sha))
    or len({base_helper, first_helper, second_helper, third_helper, fourth_helper,
            fifth_helper, sixth_helper, seventh_helper, eighth_helper,
            predecessor_helper}) != 10
):
    reject()
...
exact_directory(third_parent, [third_release])
third_root = f'{third_parent}/{third_release}'
exact_directory(third_root, ['completed-v1', 'intent-v1', 'predecessor-helper'])
third_intent_data = exact_file(f'{third_root}/intent-v1', 0o600, 4096)
third_completion_data = exact_file(f'{third_root}/completed-v1', 0o600, 4096)
third_archive = exact_file(f'{third_root}/predecessor-helper', 0o400, 2 * 1024 * 1024)
third_intent = third_intent_data.decode('ascii').splitlines()
third_completion = third_completion_data.decode('ascii').splitlines()
if (
    len(third_intent) != 18
    or len(third_completion) != 19
    or third_intent[0] != 'contract=fetanagent-kemerbet-readiness-v3-helper-rotation-v3'
    or third_intent[1] != 'state=authorized'
    or third_intent[2] != f'predecessor_release={second_release}'
    or third_intent[3] != f'successor_release={third_release}'
    or third_intent[4] != f'predecessor_helper_sha256={second_helper}'
    or third_intent[5] != f'successor_helper_sha256={third_helper}'
    or third_intent[6] != f'base_successor_intent_sha256={base_intent_sha}'
    or third_intent[7] != f'base_successor_completion_sha256={base_completion_sha}'
    or third_intent[8] != f'base_binding_v2_sha256={base_binding_v2_sha}'
    or third_intent[9] != f'base_predecessor_helper_sha256={base_old_helper_sha}'
    or third_intent[10] != f'base_binding_v3_sha256={base_binding_v3_sha}'
    or third_intent[11] !=
    ...
    or third_intent[14] != second_intent[14]
    or third_intent[15] != second_intent[15]
    or third_intent[16] != second_intent[16]
    or third_intent[17] != second_intent[17]
    or third_completion[:1] != third_intent[:1]
    or third_completion[1] != 'state=successor-installed'
    or third_completion[2:18] != third_intent[2:18]
    or third_completion[18] !=
       f'rotation_intent_sha256={hashlib.sha256(third_intent_data).hexdigest()}'
    or third_intent_data != ('\n'.join(third_intent) + '\n').encode('ascii')
    or third_completion_data != ('\n'.join(third_completion) + '\n').encode('ascii')
    or hashlib.sha256(third_archive).hexdigest() != second_helper
):
    reject()

exact_directory(fourth_parent, [fourth_release])
fourth_root = f'{fourth_parent}/{fourth_release}'
exact_directory(fourth_root, ['completed-v1', 'intent-v1', 'predecessor-helper'])
fourth_intent_data = exact_file(f'{fourth_root}/intent-v1', 0o600, 4096)
fourth_completion_data = exact_file(f'{fourth_root}/completed-v1', 0o600, 4096)
fourth_archive = exact_file(f'{fourth_root}/predecessor-helper', 0o400, 2 * 1024 * 1024)
fourth_intent = fourth_intent_data.decode('ascii').splitlines()
fourth_completion = fourth_completion_data.decode('ascii').splitlines()
if (
    len(fourth_intent) != 18
    or len(fourth_completion) != 19
    or fourth_intent[0] != 'contract=fetanagent-kemerbet-readiness-v3-helper-rotation-v4'
    or fourth_intent[1] != 'state=authorized'
    or fourth_intent[2] != f'predecessor_release={third_release}'
    or fourth_intent[3] != f'successor_release={fourth_release}'
    or fourth_intent[4] != f'predecessor_helper_sha256={third_helper}'
    or fourth_intent[5] != f'successor_helper_sha256={fourth_helper}'
    or fourth_intent[6] != f'base_successor_intent_sha256={base_intent_sha}'
    or fourth_intent[7] != f'base_successor_completion_sha256={base_completion_sha}'
    or fourth_intent[8] != f'base_binding_v2_sha256={base_binding_v2_sha}'
    or fourth_intent[9] != f'base_predecessor_helper_sha256={base_old_helper_sha}'
    or fourth_intent[10] != f'base_binding_v3_sha256={base_binding_v3_sha}'
    or fourth_intent[11] !=
       f'predecessor_rotation_intent_sha256={hashlib.sha256(third_intent_data).hexdigest()}'
    or fourth_intent[12] !=
       f'predecessor_rotation_completion_sha256={hashlib.sha256(third_completion_data).hexdigest()}'
    or fourth_intent[13] !=
       f'predecessor_rotation_helper_archive_sha256={hashlib.sha256(third_archive).hexdigest()}'
    or fourth_intent[14] != third_intent[14]
    or fourth_intent[15] != third_intent[15]
    or fourth_intent[16] != third_intent[16]
    or fourth_intent[17] != third_intent[17]
    or fourth_completion[:1] != fourth_intent[:1]
    or fourth_completion[1] != 'state=successor-installed'
    or fourth_completion[2:18] != fourth_intent[2:18]
    or fourth_completion[18] !=
       f'rotation_intent_sha256={hashlib.sha256(fourth_intent_data).hexdigest()}'
    or fourth_intent_data != ('\n'.join(fourth_intent) + '\n').encode('ascii')
    or fourth_completion_data != ('\n'.join(fourth_completion) + '\n').encode('ascii')
    or hashlib.sha256(fourth_archive).hexdigest() != third_helper
):
    reject()

exact_directory(fifth_parent, [fifth_release])
fifth_root = f'{fifth_parent}/{fifth_release}'
exact_directory(fifth_root, ['completed-v1', 'intent-v1', 'predecessor-helper'])
fifth_intent_data = exact_file(f'{fifth_root}/intent-v1', 0o600, 4096)
fifth_completion_data = exact_file(f'{fifth_root}/completed-v1', 0o600, 4096)
fifth_archive = exact_file(f'{fifth_root}/predecessor-helper', 0o400, 2 * 1024 * 1024)
fifth_intent = fifth_intent_data.decode('ascii').splitlines()
fifth_completion = fifth_completion_data.decode('ascii').splitlines()
if (
    len(fifth_intent) != 18
    or len(fifth_completion) != 19
    or fifth_intent[0] != 'contract=fetanagent-kemerbet-readiness-v3-helper-rotation-v5'
    or fifth_intent[1] != 'state=authorized'
    or fifth_intent[2] != f'predecessor_release={fourth_release}'
    or fifth_intent[3] != f'successor_release={fifth_release}'
    or fifth_intent[4] != f'predecessor_helper_sha256={fourth_helper}'
    or fifth_intent[5] != f'successor_helper_sha256={fifth_helper}'
    or fifth_intent[6] != f'base_successor_intent_sha256={base_intent_sha}'
    or fifth_intent[7] != f'base_successor_completion_sha256={base_completion_sha}'
    or fifth_intent[8] != f'base_binding_v2_sha256={base_binding_v2_sha}'
    or fifth_intent[9] != f'base_predecessor_helper_sha256={base_old_helper_sha}'
    or fifth_intent[10] != f'base_binding_v3_sha256={base_binding_v3_sha}'
    or fifth_intent[11] !=
       f'predecessor_rotation_intent_sha256={hashlib.sha256(fourth_intent_data).hexdigest()}'
    or fifth_intent[12] !=
       f'predecessor_rotation_completion_sha256={hashlib.sha256(fourth_completion_data).hexdigest()}'
    or fifth_intent[13] !=
       f'predecessor_rotation_helper_archive_sha256={hashlib.sha256(fourth_archive).hexdigest()}'
    or fifth_intent[14] != fourth_intent[14]
    or fifth_intent[15] != fourth_intent[15]
    or fifth_intent[16] != fourth_intent[16]
    or fifth_intent[17] != fourth_intent[17]
    or fifth_completion[:1] != fifth_intent[:1]
    or fifth_completion[1] != 'state=successor-installed'
    or fifth_completion[2:18] != fifth_intent[2:18]
    or fifth_completion[18] !=
       f'rotation_intent_sha256={hashlib.sha256(fifth_intent_data).hexdigest()}'
    or fifth_intent_data != ('\n'.join(fifth_intent) + '\n').encode('ascii')
    or fifth_completion_data != ('\n'.join(fifth_completion) + '\n').encode('ascii')
    or hashlib.sha256(fifth_archive).hexdigest() != fourth_helper
):
    reject()

exact_directory(sixth_parent, [sixth_release])
sixth_root = f'{sixth_parent}/{sixth_release}'
exact_directory(sixth_root, ['completed-v1', 'intent-v1', 'predecessor-helper'])
sixth_intent_data = exact_file(f'{sixth_root}/intent-v1', 0o600, 4096)
sixth_completion_data = exact_file(f'{sixth_root}/completed-v1', 0o600, 4096)
sixth_archive = exact_file(f'{sixth_root}/predecessor-helper', 0o400, 2 * 1024 * 1024)
sixth_intent = sixth_intent_data.decode('ascii').splitlines()
sixth_completion = sixth_completion_data.decode('ascii').splitlines()
if (
    len(sixth_intent) != 18
    or len(sixth_completion) != 19
    or sixth_intent[0] != 'contract=fetanagent-kemerbet-readiness-v3-helper-rotation-v6'
    or sixth_intent[1] != 'state=authorized'
    or sixth_intent[2] != f'predecessor_release={fifth_release}'
    or sixth_intent[3] != f'successor_release={sixth_release}'
    or sixth_intent[4] != f'predecessor_helper_sha256={fifth_helper}'
    or sixth_intent[5] != f'successor_helper_sha256={sixth_helper}'
    or sixth_intent[6] != f'base_successor_intent_sha256={base_intent_sha}'
    or sixth_intent[7] != f'base_successor_completion_sha256={base_completion_sha}'
    or sixth_intent[8] != f'base_binding_v2_sha256={base_binding_v2_sha}'
    or sixth_intent[9] != f'base_predecessor_helper_sha256={base_old_helper_sha}'
    or sixth_intent[10] != f'base_binding_v3_sha256={base_binding_v3_sha}'
    or sixth_intent[11] !=
       f'predecessor_rotation_intent_sha256={hashlib.sha256(fifth_intent_data).hexdigest()}'
    or sixth_intent[12] !=
       f'predecessor_rotation_completion_sha256={hashlib.sha256(fifth_completion_data).hexdigest()}'
    or sixth_intent[13] !=
       f'predecessor_rotation_helper_archive_sha256={hashlib.sha256(fifth_archive).hexdigest()}'
    or sixth_intent[14] != fifth_intent[14]
    or sixth_intent[15] != fifth_intent[15]
    or sixth_intent[16] != fifth_intent[16]
    or sixth_intent[17] != fifth_intent[17]
    or sixth_completion[:1] != sixth_intent[:1]
    or sixth_completion[1] != 'state=successor-installed'
    or sixth_completion[2:18] != sixth_intent[2:18]
    or sixth_completion[18] !=
       f'rotation_intent_sha256={hashlib.sha256(sixth_intent_data).hexdigest()}'
    or sixth_intent_data != ('\n'.join(sixth_intent) + '\n').encode('ascii')
    or sixth_completion_data != ('\n'.join(sixth_completion) + '\n').encode('ascii')
    or hashlib.sha256(sixth_archive).hexdigest() != fifth_helper
):
    reject()

exact_directory(seventh_parent, [seventh_release])
seventh_root = f'{seventh_parent}/{seventh_release}'
exact_directory(seventh_root, ['completed-v1', 'intent-v1', 'predecessor-helper'])
seventh_intent_data = exact_file(f'{seventh_root}/intent-v1', 0o600, 4096)
seventh_completion_data = exact_file(f'{seventh_root}/completed-v1', 0o600, 4096)
seventh_archive = exact_file(f'{seventh_root}/predecessor-helper', 0o400, 2 * 1024 * 1024)
seventh_intent = seventh_intent_data.decode('ascii').splitlines()
seventh_completion = seventh_completion_data.decode('ascii').splitlines()
if (
    len(seventh_intent) != 18
    or len(seventh_completion) != 19
    or seventh_intent[0] != 'contract=fetanagent-kemerbet-readiness-v3-helper-rotation-v7'
    or seventh_intent[1] != 'state=authorized'
    or seventh_intent[2] != f'predecessor_release={sixth_release}'
    or seventh_intent[3] != f'successor_release={seventh_release}'
    or seventh_intent[4] != f'predecessor_helper_sha256={sixth_helper}'
    or seventh_intent[5] != f'successor_helper_sha256={seventh_helper}'
    or seventh_intent[6] != f'base_successor_intent_sha256={base_intent_sha}'
    or seventh_intent[7] != f'base_successor_completion_sha256={base_completion_sha}'
    or seventh_intent[8] != f'base_binding_v2_sha256={base_binding_v2_sha}'
    or seventh_intent[9] != f'base_predecessor_helper_sha256={base_old_helper_sha}'
    or seventh_intent[10] != f'base_binding_v3_sha256={base_binding_v3_sha}'
    or seventh_intent[11] !=
       f'predecessor_rotation_intent_sha256={hashlib.sha256(sixth_intent_data).hexdigest()}'
    or seventh_intent[12] !=
       f'predecessor_rotation_completion_sha256={hashlib.sha256(sixth_completion_data).hexdigest()}'
    or seventh_intent[13] !=
       f'predecessor_rotation_helper_archive_sha256={hashlib.sha256(sixth_archive).hexdigest()}'
    or seventh_intent[14] != sixth_intent[14]
    or seventh_intent[15] != sixth_intent[15]
    or seventh_intent[16] != sixth_intent[16]
    or seventh_intent[17] != sixth_intent[17]
    or seventh_completion[:1] != seventh_intent[:1]
    or seventh_completion[1] != 'state=successor-installed'
    or seventh_completion[2:18] != seventh_intent[2:18]
    or seventh_completion[18] !=
       f'rotation_intent_sha256={hashlib.sha256(seventh_intent_data).hexdigest()}'
    or seventh_intent_data != ('\n'.join(seventh_intent) + '\n').encode('ascii')
    or seventh_completion_data != ('\n'.join(seventh_completion) + '\n').encode('ascii')
    or hashlib.sha256(seventh_archive).hexdigest() != sixth_helper
):
    reject()

exact_directory(eighth_parent, [eighth_release])
eighth_root = f'{eighth_parent}/{eighth_release}'
exact_directory(eighth_root, ['completed-v1', 'intent-v1', 'predecessor-helper'])
eighth_intent_data = exact_file(f'{eighth_root}/intent-v1', 0o600, 4096)
eighth_completion_data = exact_file(f'{eighth_root}/completed-v1', 0o600, 4096)
eighth_archive = exact_file(f'{eighth_root}/predecessor-helper', 0o400, 2 * 1024 * 1024)
eighth_intent = eighth_intent_data.decode('ascii').splitlines()
eighth_completion = eighth_completion_data.decode('ascii').splitlines()
if (
    len(eighth_intent) != 18
    or len(eighth_completion) != 19
    or eighth_intent[0] != 'contract=fetanagent-kemerbet-readiness-v3-helper-rotation-v8'
    or eighth_intent[1] != 'state=authorized'
    or eighth_intent[2] != f'predecessor_release={seventh_release}'
    or eighth_intent[3] != f'successor_release={eighth_release}'
    or eighth_intent[4] != f'predecessor_helper_sha256={seventh_helper}'
    or eighth_intent[5] != f'successor_helper_sha256={eighth_helper}'
    or eighth_intent[6] != f'base_successor_intent_sha256={base_intent_sha}'
    or eighth_intent[7] != f'base_successor_completion_sha256={base_completion_sha}'
    or eighth_intent[8] != f'base_binding_v2_sha256={base_binding_v2_sha}'
    or eighth_intent[9] != f'base_predecessor_helper_sha256={base_old_helper_sha}'
    or eighth_intent[10] != f'base_binding_v3_sha256={base_binding_v3_sha}'
    or eighth_intent[11] !=
       f'predecessor_rotation_intent_sha256={hashlib.sha256(seventh_intent_data).hexdigest()}'
    or eighth_intent[12] !=
       f'predecessor_rotation_completion_sha256={hashlib.sha256(seventh_completion_data).hexdigest()}'
    or eighth_intent[13] !=
       f'predecessor_rotation_helper_archive_sha256={hashlib.sha256(seventh_archive).hexdigest()}'
    or eighth_intent[14] != seventh_intent[14]
    or eighth_intent[15] != seventh_intent[15]
    or eighth_intent[16] != seventh_intent[16]
    or eighth_intent[17] != seventh_intent[17]
    or eighth_completion[:1] != eighth_intent[:1]
    or eighth_completion[1] != 'state=successor-installed'
    or eighth_completion[2:18] != eighth_intent[2:18]
    or eighth_completion[18] !=
       f'rotation_intent_sha256={hashlib.sha256(eighth_intent_data).hexdigest()}'
    or eighth_intent_data != ('\n'.join(eighth_intent) + '\n').encode('ascii')
    or eighth_completion_data != ('\n'.join(eighth_completion) + '\n').encode('ascii')
    or hashlib.sha256(eighth_archive).hexdigest() != seventh_helper
):
    reject()
...
if (
    ...
    or intent[0] != 'contract=fetanagent-kemerbet-readiness-v3-helper-rotation-v9'
    or intent[1] != 'state=authorized'
    or intent[2] != f'predecessor_release={eighth_release}'
    or intent[3] != f'successor_release={predecessor_release}'
    or intent[4] != f'predecessor_helper_sha256={eighth_helper}'
    ...
    or intent[11] !=
       f'predecessor_rotation_intent_sha256={hashlib.sha256(eighth_intent_data).hexdigest()}'
    or intent[12] !=
       f'predecessor_rotation_completion_sha256={hashlib.sha256(eighth_completion_data).hexdigest()}'
    or intent[13] !=
       f'predecessor_rotation_helper_archive_sha256={hashlib.sha256(eighth_archive).hexdigest()}'
    or intent[14] != eighth_intent[14]
    or intent[15] != eighth_intent[15]
    or intent[16] != eighth_intent[16]
    or intent[17] != eighth_intent[17]
    or completion[:1] != intent[:1]
    or completion[1] != 'state=successor-installed'
    ...
    or intent_data != ('\n'.join(intent) + '\n').encode('ascii')
    or completion_data != ('\n'.join(completion) + '\n').encode('ascii')
    or hashlib.sha256(archived_helper).hexdigest() != eighth_helper
):
    reject()
...
require_predecessor_rotation_global_residue_absent() {
  [[ ! -e "$FIRST_ROTATION_SUDOERS_DISABLED" && ! -L "$FIRST_ROTATION_SUDOERS_DISABLED" &&
    ...
    ! -e "$THIRD_ROTATION_SUDOERS_DISABLED" && ! -L "$THIRD_ROTATION_SUDOERS_DISABLED" &&
    ! -e "$THIRD_ROTATION_INSTALLING_HELPER" && ! -L "$THIRD_ROTATION_INSTALLING_HELPER" &&
    ! -e "$THIRD_ROTATION_INSTALLING_HELPER_PARTIAL" &&
      ! -L "$THIRD_ROTATION_INSTALLING_HELPER_PARTIAL" &&
    ! -e "$THIRD_ROTATION_ROLLBACK_HELPER" && ! -L "$THIRD_ROTATION_ROLLBACK_HELPER" &&
    ! -e "$THIRD_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
      ! -L "$THIRD_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
    ! -e "$FOURTH_ROTATION_SUDOERS_DISABLED" && ! -L "$FOURTH_ROTATION_SUDOERS_DISABLED" &&
    ! -e "$FOURTH_ROTATION_INSTALLING_HELPER" && ! -L "$FOURTH_ROTATION_INSTALLING_HELPER" &&
    ! -e "$FOURTH_ROTATION_INSTALLING_HELPER_PARTIAL" &&
      ! -L "$FOURTH_ROTATION_INSTALLING_HELPER_PARTIAL" &&
    ! -e "$FOURTH_ROTATION_ROLLBACK_HELPER" && ! -L "$FOURTH_ROTATION_ROLLBACK_HELPER" &&
    ! -e "$FOURTH_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
      ! -L "$FOURTH_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
    ! -e "$FIFTH_ROTATION_SUDOERS_DISABLED" && ! -L "$FIFTH_ROTATION_SUDOERS_DISABLED" &&
    ! -e "$FIFTH_ROTATION_INSTALLING_HELPER" && ! -L "$FIFTH_ROTATION_INSTALLING_HELPER" &&
    ! -e "$FIFTH_ROTATION_INSTALLING_HELPER_PARTIAL" &&
      ! -L "$FIFTH_ROTATION_INSTALLING_HELPER_PARTIAL" &&
    ! -e "$FIFTH_ROTATION_ROLLBACK_HELPER" && ! -L "$FIFTH_ROTATION_ROLLBACK_HELPER" &&
    ! -e "$FIFTH_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
      ! -L "$FIFTH_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
    ! -e "$SIXTH_ROTATION_SUDOERS_DISABLED" && ! -L "$SIXTH_ROTATION_SUDOERS_DISABLED" &&
    ! -e "$SIXTH_ROTATION_INSTALLING_HELPER" && ! -L "$SIXTH_ROTATION_INSTALLING_HELPER" &&
    ! -e "$SIXTH_ROTATION_INSTALLING_HELPER_PARTIAL" &&
      ! -L "$SIXTH_ROTATION_INSTALLING_HELPER_PARTIAL" &&
    ! -e "$SIXTH_ROTATION_ROLLBACK_HELPER" && ! -L "$SIXTH_ROTATION_ROLLBACK_HELPER" &&
    ! -e "$SIXTH_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
      ! -L "$SIXTH_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
    ! -e "$SEVENTH_ROTATION_SUDOERS_DISABLED" && ! -L "$SEVENTH_ROTATION_SUDOERS_DISABLED" &&
    ! -e "$SEVENTH_ROTATION_INSTALLING_HELPER" && ! -L "$SEVENTH_ROTATION_INSTALLING_HELPER" &&
    ! -e "$SEVENTH_ROTATION_INSTALLING_HELPER_PARTIAL" &&
      ! -L "$SEVENTH_ROTATION_INSTALLING_HELPER_PARTIAL" &&
    ! -e "$SEVENTH_ROTATION_ROLLBACK_HELPER" && ! -L "$SEVENTH_ROTATION_ROLLBACK_HELPER" &&
    ! -e "$SEVENTH_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
      ! -L "$SEVENTH_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
    ! -e "$EIGHTH_ROTATION_SUDOERS_DISABLED" && ! -L "$EIGHTH_ROTATION_SUDOERS_DISABLED" &&
    ! -e "$EIGHTH_ROTATION_INSTALLING_HELPER" && ! -L "$EIGHTH_ROTATION_INSTALLING_HELPER" &&
    ! -e "$EIGHTH_ROTATION_INSTALLING_HELPER_PARTIAL" &&
      ! -L "$EIGHTH_ROTATION_INSTALLING_HELPER_PARTIAL" &&
    ! -e "$EIGHTH_ROTATION_ROLLBACK_HELPER" && ! -L "$EIGHTH_ROTATION_ROLLBACK_HELPER" &&
    ! -e "$EIGHTH_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
      ! -L "$EIGHTH_ROTATION_ROLLBACK_HELPER_PARTIAL" &&
...
cleanup() {
  ...
  if [[ "$status" -ne 0 && "$sudoers_disabled" == 'true' ]]; then
    ...
    printf '%s\n' \
      'FetanAgent v3 tenth helper rotation stopped with the deployment grant disabled. Whether the append-only record is pending or final, rerun this exact operation with the same successor release and helper digest from the root console; do not restore the grant manually.' >&2
  fi
  exit "$status"
}
...
require_predecessor_rotation_global_residue_absent ||
  die 'one of the first nine helper rotations still has global transaction residue'
...
load_exact_predecessor_rotation_evidence ||
  die 'the exact completed nine-link helper-rotation chain is invalid'
require_predecessor_rotation_global_residue_absent ||
...
require_current_boundary_matches_predecessor_rotation ||
  die 'the current durable boundary differs from the ninth helper-rotation link'
capture_rotation_durable_boundary ||
...
load_exact_predecessor_rotation_evidence ||
  die 'the nine-link helper-rotation chain changed under lock'
require_predecessor_rotation_global_residue_absent ||
...
require_current_boundary_matches_predecessor_rotation ||
  die 'the frozen durable boundary diverged from the ninth helper-rotation link'
...
load_exact_predecessor_rotation_evidence ||
  die 'the nine-link helper-rotation chain changed after helper verification'
require_predecessor_rotation_global_residue_absent ||
...
require_current_boundary_matches_predecessor_rotation ||
  die 'the durable boundary no longer matches the ninth helper-rotation link'
...
trap - EXIT
printf '%s\n' \
  'FetanAgent v3 tenth successor helper/release rotation completed. Transfer and the live executor remained disabled; no money moved.'
