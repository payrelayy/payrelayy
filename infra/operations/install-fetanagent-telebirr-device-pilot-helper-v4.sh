...
readonly EXPECTED_HELPER_SHA256='c8e6bc84ca348771a386a6c5550cdeff7a212eea9bc29a72d24189a65414635d'
readonly PREVIOUS_HELPER_SHA256='f8a83549ad36992c1921e42cc77ee86f1f5144ec51df9623077835d6ec11a11e'
readonly STAGING_ROOT='/root/fetanagent-telebirr-device-pilot-helper-v4'
readonly SOURCE="$STAGING_ROOT/fetanagent-telebirr-device-pilot-helper.sh"
readonly INSTALLER="$STAGING_ROOT/install-fetanagent-telebirr-device-pilot-helper-v4.sh"
...
[[ "$(find "$STAGING_ROOT" -mindepth 1 -maxdepth 1 -printf '%f:%y\n' | sort)" == \
  $'fetanagent-telebirr-device-pilot-helper.sh:f\ninstall-fetanagent-telebirr-device-pilot-helper-v4.sh:f' ]] ||
