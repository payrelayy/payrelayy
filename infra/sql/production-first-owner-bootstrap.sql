...
select pg_catalog.pg_advisory_xact_lock(
  pg_catalog.hashtextextended('fetanagent:production:first-owner-bootstrap', 0)
);
...
\if :auth_user_ready
\else
  \warn 'The selected production Auth user is not present, confirmed, and active.'
...
commit;
\echo 'Exactly one active production Owner was bootstrapped and audited.'
