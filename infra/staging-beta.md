...
```text
installed_predecessor=5267906f1b0fe07c8d4a2da05f2e101240a39ee8ab73cf323d4b41d7a30b6795
reviewed_successor=d9cdcdec53e0a408bc15b205f161fd19e3204ed8e81a32e5921342c2bfa867f7
```
...
NEXT_SHA='d9cdcdec53e0a408bc15b205f161fd19e3204ed8e81a32e5921342c2bfa867f7'
[[ "$C1" =~ ^[0-9a-f]{40}$ ]]
...
BACKUP="$STAGING_ROOT/fetanagent-staging-deploy-helper.previous-5267906f"
...
PREVIOUS_SHA='5267906f1b0fe07c8d4a2da05f2e101240a39ee8ab73cf323d4b41d7a30b6795'
NEXT_SHA='d9cdcdec53e0a408bc15b205f161fd19e3204ed8e81a32e5921342c2bfa867f7'
...
against successor SHA `d9cdcdec…` before `deploy-and-smoke` is allowed. A transient SSH failure should
be diagnosed and the read-only verification retried while staging remains offline. Manual rollback
to `5267906f…` is an exceptional pre-deploy path only: it is forbidden after `deploy-and-smoke` or
...
with predecessor `5267906f`: the complete promotion and recheck receipt roots, recheck candidate,
...
TARGET='/usr/local/sbin/fetanagent-staging-deploy-helper'
BACKUP='/root/fetanagent-helper-rotation/fetanagent-staging-deploy-helper.previous-5267906f'
...
succeeds, remove only the staged `.next` file. Retain all five versioned predecessor backups: the new
`fetanagent-staging-deploy-helper.previous-5267906f` backup and the independently verified existing
...
four older backups during this rotation. This is a one-successor replacement, not ongoing
