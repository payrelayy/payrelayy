...
assert.match(workflow, /outcomeClass: \.outcome_class/u);
assert.match(workflow, /outcomeReasonClass: \.outcome_reason_class/u);
assert.match(workflow, /outcomeCreatedInsideReviewWindow/u);
...
assert.match(statusSql, /outcome_created_inside_review_window/u);
