...
assert.match(inspectSql, /membership_state\.member_role = 'postgres'/);
assert.match(inspectSql, /not membership_state\.inherit_option/);
assert.match(inspectSql, /membership_state\.admin_option/);
